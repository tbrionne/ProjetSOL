...
${session["connecte"]}
	...
	<h3>Ajout d'un produit à la base de données : </h3>
		<form action="adminAjouter" method="POST" enctype="multipart/form-data">
			<table>
				<tr>
					<td>Nom : <input type="text"  class="textImput" name="produit_name"/></td>
					<td><label for="categorie">Catégories :</label>
						<select class="selectImput" name="categorie_id" id="categorie">
					...
					<td>Marque : <input type="text"  class="textImput" name="marque"/></td>
				</tr>
				<tr>
					<td><label for="classeEnergetique">Classe énergétique :</label>
						<select class="selectImput" name="classe_energetique_id" id="classeEnergetique">
					...
					<td>Nom de la photo : <input type="file" class="textImput" name="fichierUpload"/></td>
